...
import { ArrowLeft, Building, Calendar, TrendingUp, Users, Clock, X } from 'lucide-react';
...
export function CaseStudyPreview({ formData, metrics, onClose }: CaseStudyPreviewProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-7xl w-full max-h-[95vh] overflow-hidden">
        {/* Modal Header */}
        <div className="flex items-center justify-between p-4 border-b bg-white sticky top-0 z-10">
          <h2 className="text-lg font-semibold">Preview Case Study</h2>
          <Button
            type="button"
            variant="ghost"
            size="sm"
        ...
        {/* Modal Content - Exact copy of frontend */}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center space-x-6 mb-8">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">{formData.client || 'Nama Klien'}</h2>
                ...
                <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
                  {formData.title || 'Judul Case Study'}
                </h1>

                {/* Summary */}
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  {formData.summary || 'Summary case study...'}
                </p>
                ...
                <div className="flex items-center space-x-6 text-muted-foreground">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{formData.industry || 'Industri'}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Calendar className="w-4 h-4" />
                    <span>{formData.publishedAt ? new Date(formData.publishedAt).toLocaleDateString('id-ID', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
                    }) : 'Tanggal publikasi'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="max-w-3xl mx-auto space-y-8 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-white text-white hover:bg-white btn-force-text-hover">
                    Lihat Solusi AI
                  </Button>
                </div>
              </div>
